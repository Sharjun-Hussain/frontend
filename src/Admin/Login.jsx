...
const Login = () => {
    ...
    const HandleSubmit = async (e) => {
       ...
       const response = await axios.post("http://127.0.0.1:8000/admin/login", JSON.stringify({ Email, Password }), {
            headers: {
            ...
            // redirect("http://127.0.0.1:8000/admin/dashboard")
            window.location.href = "/admin/dashboard";
            // const as = async() => {
            //     await axios.get("http://127.0.0.1:8000/admin/dashboard").then (response => {
            //         
            //     })
            // }
            // as();
